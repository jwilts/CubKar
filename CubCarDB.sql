...
-- Dumping structure for view CubCar.packlist
DROP VIEW IF EXISTS `packlist`;
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `packlist` (
	`ID` INT(11) NOT NULL,
	`PackName` VARCHAR(100) NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY INVOKER VIEW `packlist` AS SELECT * FROM packnames ;
